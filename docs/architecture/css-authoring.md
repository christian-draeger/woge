...
This page records the M0 contract. The illustrated Kotlin helpers and scoped compiler are prototypes, not released APIs yet.
...
When colocating a small sheet with Kotlin is clearer, the proposed helper accepts ordinary CSS text:
...
The executable [CSS authoring evidence](../../spikes/css-authoring/evidence.md) records the tested syntax, browser versions and prototype limitations. [ADR 0016](../adr/0016-standards-native-css-authoring.md) owns the decision.
